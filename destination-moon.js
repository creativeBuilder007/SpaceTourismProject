...
//     document.querySelector(".aboveMoonContext_moon").classList.add('activeAboveMoonContext');
// })
// elem_moon.addEventListener("mouseout",()=>{
//     document.querySelector(".aboveMoonContext_moon").classList.remove('activeAboveMoonContext')
// })
elem_mars.addEventListener("mouseover",()=>{
    document.querySelector(".aboveMoonContext_mars").classList.add('activeAboveMoonContext');
})
elem_mars.addEventListener("mouseout",()=>{
    document.querySelector(".aboveMoonContext_mars").classList.remove('activeAboveMoonContext')
})
elem_europa.addEventListener("mouseover",()=>{
    document.querySelector(".aboveMoonContext_europa").classList.add('activeAboveMoonContext');
})
elem_europa.addEventListener("mouseout",()=>{
    document.querySelector(".aboveMoonContext_europa").classList.remove('activeAboveMoonContext')
})
elem_titan.addEventListener("mouseover",()=>{
    document.querySelector(".aboveMoonContext_titan").classList.add('activeAboveMoonContext');
})
elem_titan.addEventListener("mouseout",()=>{
    document.querySelector(".aboveMoonContext_titan").classList.remove('activeAboveMoonContext')
})

document.addEventListener("keydown",(event)=>{
    let text = document.querySelector("h1").textContent;
    if(event.key=='ArrowRight' && text=='Moon'){
